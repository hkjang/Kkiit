...
export type AuthProvider = { id?: string; slug: string; name: string; preset: string; provider_type?: string; enabled?: boolean; issuer_url?: string | null; authorization_url?: string | null; token_url?: string | null; userinfo_url?: string | null; client_id?: string; secret_configured?: boolean; scopes?: string[]; claim_mapping?: Record<string, unknown>; options?: Record<string, unknown>; login_url?: string; auto_login?: boolean }
